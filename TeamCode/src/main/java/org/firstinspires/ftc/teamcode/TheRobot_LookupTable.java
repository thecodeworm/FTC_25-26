// Version 7 - Aditya Chanda - WEIGHTED LOOKUP TABLE IMPLEMENTATION
...
@TeleOp(name="TheRobot_LookupTable", group="Competition")
public class TheRobot_LookupTable extends LinearOpMode {
    ...
    private void executeShootSequence() {
        ...
        for (int shootIndex = 0; shootIndex < 3; shootIndex++) {
            ...
            if (shootIndex > 0) {
                ...
                sleep(moveDelay + 100);  // Wait for spindex to settle
        ...
        telemetry.addData("Complete", "3 balls fired with lookup table control");
        telemetry.update();
        sleep(1000);
    }
