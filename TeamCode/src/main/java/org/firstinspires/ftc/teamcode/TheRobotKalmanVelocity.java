...
@TeleOp(name="TheRobotKV", group="Competition")
public class TheRobotKalmanVelocity extends LinearOpMode {
    ...
    private static final double TX_PROCESS_NOISE = 0.05; // changed from 0.1 to - Aditya
    private static final double TX_MEASUREMENT_NOISE = 2.0; // changed from 0.5 - Aditya
    ...
    private static final double TX_GAIN = 0.025; // More responsive - Aditya
    private static final double PITCH_DEADZONE = 0.5; // More tight - Aditya
    ...
    /* ==================== INTAKE CONSTANTS (FROM VERSION 3) ==================== */
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // Auto-aim or manual control (with Kalman filtering)
            if (autoAimEnabled) {
                autoAim();
            } else {
                manualTurretControl();
    ...
    private void autoAim() {
        ...
        // sleep(150); //NP added 01/24
        // turretPitch.setPower(0); //NP added 01/14
    }
