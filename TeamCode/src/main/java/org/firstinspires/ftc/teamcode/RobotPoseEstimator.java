...
public class RobotPoseEstimator {
     ...
     */
    private static final double MAX_POSITION_JUMP_MM = 500.0;
    ...
    private void predictFromOdometry() {
        ...
        // Rotate odometry delta into field frame using current heading estimate
        double cos = Math.cos(stateHeading);
        double sin = Math.sin(stateHeading);
        double dX = cos * dOdoX - sin * dOdoY;
        double dY = sin * dOdoX + cos * dOdoY;
