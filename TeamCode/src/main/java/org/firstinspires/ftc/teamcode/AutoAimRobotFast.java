...
@TeleOp(name="AutoAimRobotFast", group="Competition")
public class AutoAimRobotFast extends LinearOpMode {
    ...
    // ---------- INTAKE CONSTANTS ----------
    private static final int SHOOT_DELAY = 100; //375
    private static final int AUTO_ROTATE_DELAY = 200; //450
    private static final int COLOR_THRESHOLD = 100; //80
    private static final int MAX_BALLS = 3;
    private static final int DETECTION_COOLDOWN = 300; //600
    private static final double INTAKE_POWER = 0.5; //0.35
    private static final int SERVO_MOVE_DELAY = 325; //750
